...
public class TravelPickupHealthCheckController {
	...
	@ApiResponse(responseCode = "200", description = "TravelPickup Health Check", content = @Content(mediaType = "application/json", schema = @Schema(type = "string", example = "TravelPickup Health Check")))
	public ResponseEntity<?> healthCheck() {
		return ResponseEntity.status(HttpStatus.OK).body(TRAVEL_PICKUP_HEALTH_CHECK_MESSAGE);
	}
