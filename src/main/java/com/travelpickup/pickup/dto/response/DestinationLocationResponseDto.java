...
public class DestinationLocationResponseDto {
	...
	@Builder
	public DestinationLocationResponseDto(String address, String addressDetail, Double latitude, Double longitude) {
	...
	public static DestinationLocationResponseDto of(PickupCenter pickupCenter) {
		return DestinationLocationResponseDto.builder()
