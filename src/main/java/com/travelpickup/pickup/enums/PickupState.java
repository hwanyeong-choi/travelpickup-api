...
public enum PickupState {
    ...
    PICKUP_REQUEST_COMPLETED("픽업 신청완료", "신청완료"),
    PICKUP_CENTER_REQUEST_COMPLETED("픽업 센터 접수완료", "센터 접수완료"),
    PICKUP_DELIVERY_AWAITING("픽업 배송대기중", "배송 대기중"),
    PICKUP_DELIVERY_IN_PROGRESS("픽업 배송중", "배송중"),
    PICKUP_DELIVERY_COMPLETED("픽업 배송완료", "배송 완료"),
    PICKUP_CANCEL("픽업 취소", "취소");
