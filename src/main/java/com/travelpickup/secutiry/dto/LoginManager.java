...
public class LoginManager implements UserDetails {
	...
	@Builder
	public LoginManager(Long id, String role, Long centerId) {
		this.id = id;
		this.role = role;
		this.centerId = centerId;
	}

	public static LoginManager of(Long id, String role, Long centerId) {
		return LoginManager.builder().id(id).role(role).centerId(centerId).build();
	}
