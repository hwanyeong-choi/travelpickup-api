...
public class KakaoOauthWebClient {
	...
	public KakaoTokenResponseDto getKakaoAccessToken(String codeValue) {
		...
		return kakaoWebTokenClient.post()
			.uri(uriBuilder -> uriBuilder.path(KAKAO_OAUTH_TOKEN_PATH).queryParams(kakaoAccessTokenQueryParam).build())
